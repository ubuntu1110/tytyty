// frontend/src/components/AdminExpenses/AdminExpensesEditForm.tsx
...
interface AdminExpensesEditFormProps {
...
const AdminExpensesEditForm: React.FC<AdminExpensesEditFormProps> = ({
                                                                         editingExpense,
                                                                         editCategory,
                                                                         setEditCategory,
                                                                         editAmount,
...
export default AdminExpensesEditForm;
